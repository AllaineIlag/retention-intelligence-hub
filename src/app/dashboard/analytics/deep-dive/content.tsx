...
import { getDeepDiveMetrics, type DeepDiveMetrics } from './actions'
...
export function DeepDiveContent() {
    const [metrics, setMetrics] = useState<DeepDiveMetrics | null>(null)
    ...
    if (loading || !metrics) return <DeepDiveSkeleton />
